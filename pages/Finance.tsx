            ...
            <tbody className="divide-y divide-slate-100">
              {filteredTransactions.map((t) => (
                <tr key={t.id} className="hover:bg-slate-50 transition-colors group">
                  <td className="px-6 py-4 font-medium text-slate-900">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        {t.frequency === 'recurring' && <span className="text-[10px] bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded border border-slate-200">Recorrente</span>}
                  ...
                  <td className={`px-6 py-4 text-right font-semibold ${t.type === 'revenue' ? 'text-emerald-600' : 'text-slate-900'}`}>
